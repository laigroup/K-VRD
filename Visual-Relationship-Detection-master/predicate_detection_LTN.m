...
for model_label_idx =1 : length(model_label_list)
    ...
    load(['results_test/predicate_det_result_new',model_label,'.mat']);
    ...
    zeroShot100R = top_recall_Relationship(100, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
    zeroShot50R = top_recall_Relationship(50, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
